...
arraydecl: 
	TGLOBAL TYPEINT TLBRACKET TINT TRBRACKET { $$ = new NArray($3, true); }
	| TGLOBAL TYPEDOUBLE TLBRACKET TINT TRBRACKET { $$ = new NArray($3, true); }
	| TGLOBAL TYPECHAR TLBRACKET TINT TRBRACKET { $$ = new NArray($3, true); }
	| TGLOBAL TYPESTRING TLBRACKET TINT TRBRACKET { $$ = new NArray($3, true); }
	| TYPEINT TLBRACKET TINT TRBRACKET {  }
	| TYPEDOUBLE TLBRACKET TINT TRBRACKET {  }
	| TYPECHAR TLBRACKET TINT TRBRACKET {  }
	| TYPESTRING TLBRACKET TINT TRBRACKET {  }
	;
